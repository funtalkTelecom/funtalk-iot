...
public final class DateUtil {
    ...
    public final static String TIME_SECOND_FORMAT = "HH:mm:ss";
     ...
     * @return
     */
    public static Date parseTimeSecondDate(String date) {
        SimpleDateFormat format = new SimpleDateFormat(TIME_SECOND_FORMAT);
        try {
            return format.parse(date);
        } catch (ParseException e) {
            return new Date();
    ...
    public static String getDateStrByLongTime(Long times){
    	Date date = new Date(times);
    	return formatDate(date,FULL_DATE_TIME_FORMAT);
    }
    
    
    public static void main(String[] args) {
    	System.out.println(DateUtil.formatFullDate(new Date()));
		System.out.println(  DateUtil.getDateStrByLongTime(new Date().getTime()-600*1000l));
	}
}
