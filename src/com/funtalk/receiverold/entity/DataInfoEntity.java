...
public class DataInfoEntity {
	...
	private ArrayList<String> phone_list = null;	//:{"p1":"接收号码1",p2:"接收号码2",...}
	private String sms_msg = ""; 			// :"发送短信内容"
	private String message_Cnt="";
	private ArrayList<String> sms_list = null;	//:{"m1":"短信内容1",m2:"短信内容2",...}
	...
	public ArrayList<String> getSms_list() {
		return sms_list;
	}
	public void setSms_list(ArrayList<String> sms_list) {
